...
| **파일 경로** | `/Users/younghoon-kang/Data_Analysis_Project/raw_data.csv` |
...
아래 항목들은 **`baseball_baseline.py` 내부**에서 자동 처리됩니다.  
데이터 담당자는 위 원본 컬럼만 맞춰주면 됩니다.
